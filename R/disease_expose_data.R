...
#'
#' @description A simple example of a \code{data.frame} of disease-exposure/disease-risk factor data that could be used with this package and is used in examples
#'
...
#' \item{exposure3}{character column specifying which category of an exposure/risk factor the person falls into (are they a child, office worker, shop worker, etc.)}
#' }
"disease_expose_data"
